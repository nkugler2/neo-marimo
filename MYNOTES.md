...
1. Do `git -C ~/.local/share/nvim/site/pack/core/opt/neo-marimo pull` to grab the
   most recent version (make sure I start with `!` if I am doing this in neovim,
...
Checkhealth will give a warning for this because it is not updating the "normal"
way for vim.pack. That is fine as long as I do this.
